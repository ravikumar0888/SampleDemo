...
public class ConfigreaderUtils {
	...
	static {
		LOGGER = LogManager.getLogger(ConfigreaderUtils.class.getName());
		configs = new Configurations();
		try {

			config = configs.xml(ConfigreaderUtils.class.getResource("/config.xml"));
	 ...
	 * 
	 * @param configXpath
	 *            xpath key for the needed value
	 ...
	 * 
	 * @param configXpath
	 *            xpath key for the needed values
	 * @return List<String>
	 */
