...
public class EVREP_SCT_001_Init_OrgaTest extends BasePage {
	static Logger logger = LogManager.getLogger(EVREP_SCT_001_Init_OrgaTest.class.getName());
	...
	@Test(description = "")
	public void EVREP_SCT_001_Init_Orga() {
