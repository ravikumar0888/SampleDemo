...
// few test steps added in part 2 to covered mandate flow
public class MandateManagement462_Part2Test extends BasePage {
	static Logger logger = LogManager.getLogger(MandateManagement462_Part2Test.class.getName());
	...
	public MandateManagement462_Part2Test() {
		super();
	}
	...
	public void MandateManagement462_Part2() throws InterruptedException {
