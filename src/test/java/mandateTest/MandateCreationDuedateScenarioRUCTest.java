...
/*https://jira.worldline.com/browse/FPLSPSTEST-465 step 1 to 8
*/
public class MandateCreationDuedateScenarioRUCTest extends BasePage {
	static Logger logger = LogManager.getLogger(MandateCreationDuedateScenarioRUCTest.class.getName());
	...
	public void MandateCreationDuedateScenarioRUC() throws InterruptedException {
