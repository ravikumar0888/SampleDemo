...
public class MandateCreationByRestTest extends BasePage {
	static Logger logger = LogManager.getLogger(MandateCreationByRestTest.class.getName());

	@Description("To Create a mandate with REST API")
	@Test(description = "To Create a mandate with REST API")

	public void MandateCreationByRest() throws InterruptedException {
