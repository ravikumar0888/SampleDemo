...
public class DSCardPaymentOKUndefinedFlowTest extends BasePage {
	static Logger logger = LogManager.getLogger(DSCardPaymentOKUndefinedFlowTest.class.getName());
	...
	@Test(enabled = false)
	public void DSCardPaymentOKUndefinedFlow() {
		...
		LinkedTreeMap<String, ?> cardPayment = JsonManager.getMapfromJson("testdata/cardpayment.json", "CardPaymentSucess");
		...
		signStep1.documentSignatureStep1Undefined();
