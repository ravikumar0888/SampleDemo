...
public class DSGetSessionStatusTest extends BasePage {
	static Logger logger = LogManager.getLogger(DSGetSessionStatusTest.class.getName());
	...
	@Test
	public void testDSGetSessionStatus() {
		Gson gson = new Gson();
		...
		String actualStatus = rest.getSessionStatus(initSession.getCreditorParameters().getCreditorId(), transId);
		if (!(actualStatus.equals("Finished") || actualStatus.equals("Success"))) {
			assertTrue(false);
		}
	}
}
