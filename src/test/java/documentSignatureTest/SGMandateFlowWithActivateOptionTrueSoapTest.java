...
public class SGMandateFlowWithActivateOptionTrueSoapTest extends BasePage {
	static Logger logger = LogManager.getLogger(SGMandateFlowWithActivateOptionTrueSoapTest.class.getName());
	...
	@Test
	public void SGMandateFlowWithActivateOptionTrueSoap() throws SAXException, IOException, ParserConfigurationException,
			TransformerException, KeyStoreException, WSSecurityException {
		...
		String creditorSettingForTest = JsonManager.getStringfromJson("testdata/signCreditors.json",
				"SGMandateFlowWithActivateOptionTrueSoapTest");
		...
		signStep1.fillingIbanEmailAndPhoneOnlyForActive(backofficeSession); 
