...
public class DSResentOTPFunctinalityTest extends BasePage {
	static Logger logger = LogManager.getLogger(DSResentOTPFunctinalityTest.class.getName());
	...
	@Test
	public void DSResentOTPFunctinality() {
		...
		logger.info("Updated file " + updatedInitSession);
		...
		signStep2.resendOTP(initSession);
		try {
