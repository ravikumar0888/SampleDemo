...
public class DSMandateFlowTest extends BasePage {
	static Logger logger = LogManager.getLogger(DSMandateFlowTest.class.getName());
	...
	public void DSMandateFlow() {
		...
		navigateToUrl(url);
		signStep1.documentSignatureStep1(false, true); // first parameter for DS and second Mandate
