...
public class Rest_DSGetSessionStateTest extends BasePage {
	...
	@Test
	public void Rest_DSGetSessionState() throws IOException {
	...
	*/
	...
	//	String abc= rest.getArchivedDocument("ztestDoS",transId,transId);
		...
		String abc= rest.getSessionStatus("ztestDoS",transId);
