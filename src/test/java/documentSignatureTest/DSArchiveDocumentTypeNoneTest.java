...
public class DSArchiveDocumentTypeNoneTest extends BasePage {
	...
	@Test
	public void testDSDocumentPaymentTypeNone() throws IOException {
		...
		//String signedDocument = rest.getArchivedDocument(initSession.getCreditorParameters().getCreditorId(), transId, sp.getSessionDocumentSignature().getDocumentId());

		//assertTrue(pdfManager.compareBase64EncodedPDFText(signedDocument, sp.getSessionDocumentSignature().getDocumentFile()));
