...
public class DSDeleteSessionTest extends BasePage {
	static Logger logger = LogManager.getLogger(DSDeleteSessionTest.class.getName());
	...
	@Test
	public void testDSDeleteSession() {
		Gson gson = new Gson();
		...
		//	signStep3.documentSignatureStep3(); // after step 3 status are non cancellable i.e. success and completed
		rest.deleteSessionAndVerify(initSession.getCreditorParameters().getCreditorId(), transId);
