...
public class SMoneyWithEmailAgreementTypeTest extends BasePage {
	static Logger logger = LogManager.getLogger(SMoneyWithEmailAgreementTypeTest.class.getName());

	@Test(enabled = true)
	public void sMoneyWithEmailAgreementType() {
