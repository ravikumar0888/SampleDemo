...
public class DSCardPaymentOKFlowTest extends BasePage {
	static Logger logger = LogManager.getLogger(DSCardPaymentOKFlowTest.class.getName());
	...
	@Test(enabled = false)
	public void DSCardPaymentOKFlow() {
		...
		System.out.println("the transcation id is" +transId);
