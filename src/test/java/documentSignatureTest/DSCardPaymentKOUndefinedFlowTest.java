...
public class DSCardPaymentKOUndefinedFlowTest extends BasePage {
	static Logger logger = LogManager.getLogger(DSCardPaymentKOUndefinedFlowTest.class.getName());
	...
	@Test(enabled = false)
	public void DSCardPaymentKOUndefinedFlow() {
