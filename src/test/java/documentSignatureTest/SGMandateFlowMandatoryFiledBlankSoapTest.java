...
public class SGMandateFlowMandatoryFiledBlankSoapTest extends BasePage {
	static Logger logger = LogManager.getLogger(SGMandateFlowMandatoryFiledBlankSoapTest.class.getName());

	@Test
	public void SGMandateFlowMandatoryFiledBlank() throws ParserConfigurationException, SAXException, IOException,
		...
		Document doc = XMLManager.getXmlDocument("soaprequests/SGMandateFlowMandatoryFiledBlankSoapTest.xml");
