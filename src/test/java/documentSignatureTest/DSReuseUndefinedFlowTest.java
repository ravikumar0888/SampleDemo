...
public class DSReuseUndefinedFlowTest extends BasePage {
	static Logger logger = LogManager.getLogger(DSReuseUndefinedFlowTest.class.getName());
	...
	@Test
	public void DSReuseUndefinedFlow() {
		 ...
		 */
		/*
		 * String backOffice = "https://ssl-sps-sign-service.vm-rct.stg.as8677.net/backoffice/"; navigateToUrl(backOffice); cp.searchCreditorId(); cp.checkReuseMandateCheckBox();
		 */
		LinkedTreeMap<String, ?> testdata = JsonManager.getMapfromJson("testdata/testdata.json", "DSReuseUndefinedFlowTest");
		...
		String creditorSettingForTest = JsonManager.getStringfromJson("testdata/signCreditors.json", "DSReuseUndefinedFlowTest");
		...
		sds.setDocumentPaymentType("UNDEFINED");//  UNDEFINED 
		...
		navigateToUrl(url);
		signStep1.resumeMandateStep1Undefined(false, true); // first parameter for DS and second Mandate
