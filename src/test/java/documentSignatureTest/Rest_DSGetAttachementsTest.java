...
public class Rest_DSGetAttachementsTest extends BasePage {
	static Logger logger = LogManager.getLogger(Rest_DSGetAttachementsTest.class.getName());
	...
	@Test
	public void Rest_DSGetAttachements() throws IOException {
