...
public class SGMandateFlowWithActivateOptionDisableCorrectionTest extends BasePage {
	static Logger logger = LogManager.getLogger(SGMandateFlowWithActivateOptionDisableCorrectionTest.class.getName());
	

	@Test
	public void SGMandateFlowWithActivateOptionDisableCorrection() {
		...
		signback.activateReturnMandate();
		...
		/*
		 * action.waitForPageURL(getDriver(), "http://127.0.0.1/okURL"); action.validateURL("http://127.0.0.1/okURL");
		 */
	...
	public void disable() {
		...
		shp.signOldbackOfficeURLLaunchSG();
		//navigateToUrl(backofficeSG);
		signback.deActivateReturnMandate();
	}
}
