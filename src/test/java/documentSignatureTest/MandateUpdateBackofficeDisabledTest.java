...
public class MandateUpdateBackofficeDisabledTest extends BasePage {
	static Logger logger = LogManager.getLogger(MandateUpdateBackofficeDisabledTest.class.getName());
	...
	@Test
	public void MandateUpdateBackofficeDisabled() {
		...
		String creditorSettingForTest = JsonManager.getStringfromJson("testdata/signCreditors.json", "MandateUpdateBackofficeDisabledTest");
		...
		sbo.verifyMandateUpdateDisabled();
