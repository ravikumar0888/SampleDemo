...
public class EVREP_SDD_007_Format_CSVTest extends BasePage {
	static Logger logger = LogManager.getLogger(EVREP_SDD_007_Format_CSVTest.class.getName());
	...
	public void EVREP_SDD_007_Format_CSV() throws IOException, InterruptedException {
	...
	//	erp.selectLanguage();
		...
		mp.selectMenu("File Supervision","Event Report Search");
		erp.changeModelFormatSDD("XML");
		
		String path = fm.getLatestXmltoDelete("zip");
		fm.deleteDownloadedFile(path);
		
		String xmlpath = fm.getLatestXmltoDelete("csv");
