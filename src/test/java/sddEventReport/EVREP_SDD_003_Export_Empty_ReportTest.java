...
public class EVREP_SDD_003_Export_Empty_ReportTest extends BasePage {
	static Logger logger = LogManager.getLogger(EVREP_SDD_003_Export_Empty_ReportTest.class.getName());
	...
	public void EVREP_SDD_003_Export_Empty_Report() throws IOException, InterruptedException {
