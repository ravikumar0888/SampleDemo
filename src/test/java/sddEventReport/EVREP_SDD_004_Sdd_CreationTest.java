...
public class EVREP_SDD_004_Sdd_CreationTest extends BasePage {
	static Logger logger = LogManager.getLogger(EVREP_SDD_004_Sdd_CreationTest.class.getName());
	...
	public void EVREP_SDD_004_Sdd_Creation() throws IOException, InterruptedException {
