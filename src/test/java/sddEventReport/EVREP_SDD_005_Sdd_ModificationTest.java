...
public class EVREP_SDD_005_Sdd_ModificationTest extends BasePage {
	static Logger logger = LogManager.getLogger(EVREP_SDD_005_Sdd_ModificationTest.class.getName());
	...
	public void EVREP_SDD_005_Sdd_Modification() throws IOException, InterruptedException {
