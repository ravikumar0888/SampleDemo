...
/*	 ClassLoader classLoader = getClass().getClassLoader();
	 String emailableReportTemplateFile  = classLoader.getResource("Reporttemplate.html").getPath();
	...
	*/
	...
	public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites, String outputDirectory) {
		...
		try
		{
			...
			String customReportTitle = this.getCustomReportTitle("SPS & SPS SIGN AUTOMATION TEST RESULT");
			...
			String s = customTestMethodSummary;
			s =s.replaceAll("\\$","\\\\\\$");
			...
			File targetFile = new File(outputDirectory + "/SPS_Automation_Test_Report.html");
	...
	//	try {
	      ...
	      return FileManager.readFile("Reporttemplate.html");
	...
	private String getTestMethodReport(String testName, IResultMap testResultMap, boolean passedReault, boolean skippedResult)
	{
		...
		// color change
	//	final Color VERY_LIGHT_GRAY = new Color(199,77,77);
